...
export const ALL_HOST_CONFIGS: HostConfig[] = [claude, codex, factory, kiro, opencode, copilot, slate, cursor, openclaw];
...
export { claude, codex, factory, kiro, opencode, copilot, slate, cursor, openclaw };
